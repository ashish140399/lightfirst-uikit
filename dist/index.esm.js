...
var Icon$2f = function (props) { return (React__default.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var Icon$2e = function (props) { return (React__default.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var Icon$1k = function (props) { return (React__default.createElement(Svg, __assign({ viewBox: "0 0 23 21" }, props),
...
var IconModule = /*#__PURE__*/Object.freeze({
    __proto__: null,
    AccountFilledIcon: Icon$2f,
    AccountIcon: Icon$2e,
    AddIcon: Icon$2d,
    ArrowBackIcon: Icon$2c,
    ArrowDownIcon: Icon$2b,
    ArrowDropDownIcon: Icon$2a,
    ArrowDropUpIcon: Icon$29,
    ArrowFirstIcon: Icon$28,
    ArrowForwardIcon: Icon$27,
    ArrowLastIcon: Icon$26,
    ArrowUpIcon: Icon$25,
    AutoRenewIcon: Icon$24,
    BinanceChainIcon: Icon$23,
    BinanceIcon: Icon$22,
    BlockIcon: Icon$2h,
    BnbUsdtPairTokenIcon: Icon$21,
    BscScanIcon: Icon$20,
    BunnyCardsIcon: Icon$1$,
    BunnyPlaceholderIcon: Icon$1_,
    CalculateIcon: Icon$1Z,
    CameraIcon: Icon$1Y,
    Cards: Icon$1X,
    CardViewIcon: Icon$1W,
    ChartDisableIcon: Icon$1V,
    ChartIcon: Icon$1U,
    CheckmarkCircleFillIcon: Icon$1T,
    CheckmarkCircleIcon: Icon$2j,
    CheckmarkIcon: Icon$1S,
    ChevronDownIcon: Icon$1R,
    ChevronLeftIcon: Icon$1Q,
    ChevronRightIcon: Icon$1P,
    ChevronUpIcon: Icon$1O,
    CircleOutlineIcon: Icon$1N,
    CloseIcon: Icon$1M,
    CogIcon: Icon$1L,
    Coin98Icon: Icon$1K,
    CommunityFilledIcon: Icon$1J,
    CommunityIcon: Icon$1I,
    CopyIcon: Icon$1H,
    CrownIcon: Icon$1G,
    CurrencyIcon: Icon$1F,
    DiscordIcon: Icon$1E,
    EarnFilledIcon: Icon$1D,
    EarnFillIcon: Icon$1C,
    EarnIcon: Icon$1B,
    EllipsisIcon: Icon$1A,
    ErrorIcon: Icon$2i,
    ExpandIcon: Icon$1z,
    FarmIcon: Icon$1y,
    GithubIcon: Icon$1x,
    GroupsIcon: Icon$1w,
    HamburgerCloseIcon: Icon$1v,
    HamburgerIcon: Icon$1u,
    HelpIcon: Icon$1t,
    HistoryIcon: Icon$1s,
    HomeIcon: Icon$1r,
    IfoIcon: Icon$1q,
    InfoIcon: Icon$2g,
    InstagramIcon: Icon$1p,
    LanguageCurrencyIcon: Icon$1o,
    LanguageIcon: Icon$1n,
    LaurelLeftIcon: Icon$1m,
    LaurelRightIcon: Icon$1l,
    LineGraphIcon: Icon$1k,
    ListViewIcon: Icon$1j,
    LoginIcon: Icon$1i,
    LogoIcon: Icon$1h,
...
var ExpandableButton = function (_a) {
    ...
    return (React__default.createElement(IconButton, { "aria-label": "Hide or show expandable content", onClick: onClick },
        children,
        expanded ? React__default.createElement(Icon$1O, { color: "invertedContrast" }) : React__default.createElement(Icon$1R, { color: "invertedContrast" })));
};
...
var ExpandableLabel = function (_a) {
    var onClick = _a.onClick, expanded = _a.expanded, children = _a.children;
    return (React__default.createElement(Button, { variant: "text", "aria-label": "Hide or show expandable content", onClick: onClick, endIcon: expanded ? React__default.createElement(Icon$1O, { color: "primary" }) : React__default.createElement(Icon$1R, { color: "primary" }) }, children));
};
    ...
    return (React__default.createElement(StyledAlert, null,
        ...
        onClick && (React__default.createElement(CloseHandler, null,
            React__default.createElement(IconButton, { scale: "sm", variant: "text", onClick: onClick },
                React__default.createElement(Icon$1M, { width: "24px", color: "currentColor" }))))));
};
        ...
        React__default.createElement(Flex, { justifyContent: "flex-end" },
            React__default.createElement(Box, null,
                React__default.createElement(Flex, { alignItems: "center" },
                    React__default.createElement(StyledInput$1, __assign({ pattern: "^[0-9]*[.,]?[0-9]{0,".concat(decimals, "}$"), inputMode: "decimal", min: "0", value: value, onChange: handleOnChange, placeholder: placeholder, ref: innerRef }, inputProps)),
...
var insertSeparators = function (items, separator) {
    return items.reduce(function (accum, item, index) {
        ...
        return __spreadArray(__spreadArray([], accum, true), [
            React__default.createElement(Separator, { "aria-hidden": true, key: "seperator-".concat(index) }, separator),
            item,
        ], false);
    }, []);
};
var DefaultSeparator = React__default.createElement(Icon$1P, { color: "currentColor", width: "24px" });
var Breadcrumbs = function (_a) {
    var _b = _a.separator, separator = _b === void 0 ? DefaultSeparator : _b, children = _a.children;
    var validItems = Children.toArray(children).filter(function (child) { return isValidElement(child); });
    var items = insertSeparators(validItems, separator);
    return (React__default.createElement(StyledBreadcrumbs, null, items.map(function (item, index) { return (React__default.createElement("li", { key: "child-".concat(index) }, item)); })));
};
...
var MountAnimation = keyframes(templateObject_1$Y || (templateObject_1$Y = __makeTemplateObject(["\n    0% {\n      bottom: ", "px;\n    }\n    100% {\n      bottom: ", "px\n    }\n  "], ["\n    0% {\n      bottom: ", "px;\n    }\n    100% {\n      bottom: ", "px\n    }\n  "])), -window.innerHeight, -window.innerHeight * 0.01);
...
var DrawerContainer = styled.div(templateObject_4$a || (templateObject_4$a = __makeTemplateObject(["\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  z-index: 10;\n  border-top-left-radius: 32px;\n  border-top-right-radius: 32px;\n  position: fixed;\n  animation: ", " 350ms ease forwards;\n  padding-bottom: env(safe-area-inset-bottom);\n  z-index: 21;\n  ", "\n"], ["\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  z-index: 10;\n  border-top-left-radius: 32px;\n  border-top-right-radius: 32px;\n  position: fixed;\n  animation: ", " 350ms ease forwards;\n  padding-bottom: env(safe-area-inset-bottom);\n  z-index: 21;\n  ", "\n"])), window.innerHeight * 0.81, function (_a) {
    var theme = _a.theme;
...
var StyledOverlay = styled(Box)(templateObject_1$X || (templateObject_1$X = __makeTemplateObject(["\n  position: fixed;\n  top: 0px;\n  left: 0px;\n  width: 100%;\n  height: 100%;\n  background-color: ", ";\n  backdrop-filter: blur(2px);\n  z-index: 20;\n"], ["\n  position: fixed;\n  top: 0px;\n  left: 0px;\n  width: 100%;\n  height: 100%;\n  background-color: ", ";\n  backdrop-filter: blur(2px);\n  z-index: 20;\n"])), function (_a) {
    var theme = _a.theme;
        ...
        React__default.createElement(DrawerContainer, { ref: ref, isUnmounting: !isOpen },
            React__default.createElement(Box, { position: "absolute", right: "16px", top: "0" },
                React__default.createElement(IconButton, { variant: "text", onClick: function () { return setIsOpen(false); } },
                    React__default.createElement(Icon$1M, null))),
...
var pulse = keyframes(templateObject_2$s || (templateObject_2$s = __makeTemplateObject(["\n  0% {\n    opacity: 1;\n  }\n  50% {\n    opacity: 0.4;\n  }\n  100% {\n    opacity: 1;\n  }\n"], ["\n  0% {\n    opacity: 1;\n  }\n  50% {\n    opacity: 0.4;\n  }\n  100% {\n    opacity: 1;\n  }\n"])));
...
var Waves = styled(Root)(templateObject_5$6 || (templateObject_5$6 = __makeTemplateObject(["\n  position: relative;\n  overflow: hidden;\n  transform: translate3d(0, 0, 0);\n  &:before {\n    content: \"\";\n    position: absolute;\n    background-image: linear-gradient(90deg, transparent, rgba(243, 243, 243, 0.5), transparent);\n    top: 0;\n    left: -150px;\n    height: 100%;\n    width: 150px;\n    animation: ", " 2s cubic-bezier(0.4, 0, 0.2, 1) infinite;\n  }\n"], ["\n  position: relative;\n  overflow: hidden;\n  transform: translate3d(0, 0, 0);\n  &:before {\n    content: \"\";\n    position: absolute;\n    background-image: linear-gradient(90deg, transparent, rgba(243, 243, 243, 0.5), transparent);\n    top: 0;\n    left: -150px;\n    height: 100%;\n    width: 150px;\n    animation: ", " 2s cubic-bezier(0.4, 0, 0.2, 1) infinite;\n  }\n"])), waves);
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default.createElement(PriceLink, { href: "https://pancakeswap.finance/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82", target: "_blank" },
        ...
        React__default.createElement(Text, { color: color, bold: true }, "$".concat(cakePriceUsd.toFixed(3))))) : (React__default.createElement(Skeleton, { width: 80, height: 24 }));
};
...
var FallingBunnies = function (_a) {
    ...
    var bunnies = __spreadArray([], Array(count), true).map(function (_, index) { return (React__default.createElement(Bunny, { key: String(index), position: Math.random() * 100, iterations: iterations, duration: duration },
        React__default.createElement(Icon$1h, { width: size, height: size }))); });
...
var StyledBunnyPlaceholder = styled(Icon$1_)(templateObject_2$o || (templateObject_2$o = __makeTemplateObject(["\n  height: 100%;\n  width: 100%;\n"], ["\n  height: 100%;\n  width: 100%;\n"])));
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "transparent", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", backgroundAlt2: "rgba(255, 255, 255, 0.7)", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#fff", textDisabled: "#BDC2C4", textSubtle: "#308FFF", disabled: "#E9EAEB", gradients: {
...
var Progress = function (_a) {
    ...
    return (React__default.createElement(StyledProgress, { "$useDark": useDark, variant: variant, scale: scale },
        showProgressBunny && (React__default.createElement(ProgressBunnyWrapper, { style: { left: "".concat(stepGuard(primaryStep), "%") } },
            React__default.createElement(Icon$O, null))),
        React__default.createElement(Bar, { "$useDark": useDark, primary: true, style: { width: "".concat(stepGuard(primaryStep), "%") } }),
        secondaryStep ? React__default.createElement(Bar, { "$useDark": useDark, style: { width: "".concat(stepGuard(secondaryStep), "%") } }) : null));
};
...
var FloatingPanIcon = styled(Icon$1)(templateObject_5$4 || (templateObject_5$4 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var Spinner = function (_a) {
    var _b = _a.size, size = _b === void 0 ? 128 : _b;
    return (React__default.createElement(Container, null,
        React__default.createElement(RotatingPancakeIcon, { width: "".concat(size * 0.5, "px") }),
        React__default.createElement(FloatingPanIcon, { width: "".concat(size, "px") })));
};
...
var ModalCloseButton = function (_a) {
    ...
    return (React__default.createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
        React__default.createElement(Icon$1M, { color: "primary" })));
};
var ModalBackButton = function (_a) {
    ...
    return (React__default.createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
        React__default.createElement(Icon$2c, { color: "primary" })));
};
...
var Modal = function (_a) {
    var title = _a.title, onDismiss = _a.onDismiss, onBack = _a.onBack, children = _a.children, _b = _a.hideCloseButton, hideCloseButton = _b === void 0 ? false : _b, _c = _a.bodyPadding, bodyPadding = _c === void 0 ? "24px" : _c; _a.headerBackground; var _e = _a.minWidth, minWidth = _e === void 0 ? "320px" : _e, props = __rest(_a, ["title", "onDismiss", "onBack", "children", "hideCloseButton", "bodyPadding", "headerBackground", "minWidth"]);
    useTheme();
        ...
        React__default.createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            ...
            React__default.createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                ...
                React__default.createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default.createElement(Button, { as: "a", href: "https://pancakeswap.finance/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82", target: "_blank", scale: "sm", endIcon: React__default.createElement(Icon$27, { color: lightColors.backgroundAlt }) }, buyCakeLabel))))));
};
...
var MenuItems = function (_a) {
    ...
    return (React__default.createElement(Flex, __assign({}, props), items.map(function (_a) {
        ...
        return (React__default.createElement(DropdownMenu, { key: "".concat(label, "#").concat(href, "#").concat(icon), items: menuItems, py: 1, activeItem: activeSubItem },
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(Icon$1h, { className: "mobile-icon" }),
...
var Menu$1 = function (_a) {
    ...
    return (React__default.createElement(Wrapper, null,
        ...
        subLinks && (React__default.createElement(Flex, { justifyContent: "space-around" },
            React__default.createElement(SubMenuItems, { items: subLinksWithoutMobile, mt: "".concat(totalTopMenuHeight + 1, "px"), activeItem: activeSubItem }),
            (subLinksMobileOnly === null || subLinksMobileOnly === void 0 ? void 0 : subLinksMobileOnly.length) > 0 && (React__default.createElement(SubMenuItems, { items: subLinksMobileOnly, mt: "".concat(totalTopMenuHeight + 1, "px"), activeItem: activeSubItem, isMobileOnly: true })))),
        React__default.createElement(BodyWrapper, { mt: !subLinks ? "".concat(totalTopMenuHeight + 1, "px") : "0" },
...
var UserMenu = function (_a) {
    ...
    return (React__default.createElement(Flex, __assign({ alignItems: "center", height: "100%", ref: setTargetRef }, props),
        React__default.createElement(StyledUserMenu, { onTouchStart: function () {
            ...
            React__default.createElement(Icon$1R, { color: "text", width: "24px" })),
